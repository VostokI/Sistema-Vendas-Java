...
public class FrmProdutos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelFotoProduto.setMaximumSize(new java.awt.Dimension(150, 200));
        labelFotoProduto.setMinimumSize(new java.awt.Dimension(150, 200));
        labelFotoProduto.setPreferredSize(new java.awt.Dimension(150, 200));
                ...
                .addGroup(painel_dadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(painel_dadosLayout.createSequentialGroup()
                        ...
                        .addGroup(painel_dadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtUrlImagem, javax.swing.GroupLayout.PREFERRED_SIZE, 785, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addComponent(labelFotoProduto, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        painel_dadosLayout.setVerticalGroup(
            ...
            .addGroup(painel_dadosLayout.createSequentialGroup()
                .addGap(11, 11, 11)
                .addGroup(painel_dadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(labelFotoProduto, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(painel_dadosLayout.createSequentialGroup()
    ...
    private void btnbuscaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscaActionPerformed
        ...
        new InsereImagemURL().emLabel(labelFotoProduto, null);
        ...
        if (obj.getDescricao() != null) {
            ...
            new InsereImagemURL().emLabel(labelFotoProduto, obj.getUrlImagem());
    ...
    private void btnsalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsalvarActionPerformed
        ...
        if( ! check.descricaoValido(txtdescricao.getText())){
            return;
        }
        obj.setDescricao(txtdescricao.getText());
        
        if( ! check.precoValido(txtpreco.getText())){
            return;
        }
        obj.setPreco(Double.parseDouble(txtpreco.getText()));
        
        if( ! check.quantidadeValido(txtqtdestoque.getText())){
            return;
        }
    ...
    private void tabelaProdutosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaProdutosMouseClicked
        ...
        try{
            String url = new ProdutosDAO().findUrlImgById(txtcodigo.getText());
            new InsereImagemURL().emLabel(labelFotoProduto, url);
