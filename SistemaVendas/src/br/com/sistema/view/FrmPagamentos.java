...
public class FrmPagamentos extends javax.swing.JFrame {
    ...
    public FrmPagamentos(Clientes cliente) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnfinalizar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/comegulo.png"))); // NOI18N
        ...
        labelCarteira.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        labelCarteira.setText("CARTEIRA:");

        txtCarteira.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addComponent(txtCarteira, javax.swing.GroupLayout.PREFERRED_SIZE, 194, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addGap(38, 38, 38)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void btnfinalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnfinalizarActionPerformed
        ...
        double pcarteira, pcartao, pcheque, pdinheiro, totalpago, totalvenda, troco, saldoCarteira;
        ...
        pcarteira = Double.parseDouble(txtCarteira.getText());
        
        if(pcartao < 0 || pcheque < 0 || pdinheiro < 0 || pcarteira < 0){
            JOptionPane.showMessageDialog(null, "Nenhum pagamento deve ser menor que 0!");
            return;
            
        }
        
        saldoCarteira = this.carteira.getSaldo();
        if(saldoCarteira < pcarteira){
            JOptionPane.showMessageDialog(null, "Não há saldo suficiente na carteira do cliente!");
            return;
        }
        ...
        totalpago = pcartao + pcheque + pdinheiro + pcarteira;
        ...
        if(this.carteira.debitar(pcarteira)){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPagamentos(null).setVisible(true);
            }
        });
    }
